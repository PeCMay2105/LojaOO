...
public class Administrador extends Pessoa {
    ...
    public int CadastraCliente(String nome,String CPF, int id, int idade, String login, String senha, boolean possuiCartao ){
        ...
        System.out.println("Cliente Caadastrado com sucesso!");
        return 1;
    }

    /*public int CadastraVendedor(String nome, String CPF, int id, int idade){
        ...
        Vendedor novoVendedor = new Vendedor(nome,CPF,id,idade,new ArrayList<>());
        clientes.add(novoVendedor);
        System.out.println("Vendedor Caadastrado com sucesso!");
        return 1;
    }
    }*/
